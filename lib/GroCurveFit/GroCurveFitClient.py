...
class GroCurveFit(object):
    ...
    def fit_growth_curve(self, workspace_name, growth_matrix_id, parameters_obj_name, fit_method, json_rpc_context = None):
        ...
        resp = self._call('GroCurveFit.fit_growth_curve',
                          [workspace_name, growth_matrix_id, parameters_obj_name, fit_method], json_rpc_context)
        return resp[0]
